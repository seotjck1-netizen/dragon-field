...
const DEEP_TILES = {
  // 지하감옥 바닥 — 깨진 판석 (0.67).
  //
  // 예전에는 줄눈이 곧은 격자였다. 복도를 길게 깔면 모눈종이가 된다.
  // 판석을 크게 잡고 금·잔돌·물자국을 얹어 '오래된 바닥'으로 만든다.
  dungeon_floor: t(`
    <rect width="32" height="32" fill="#2f2e39"/>
    <g stroke="none">
      <rect x="0.6" y="0.6" width="18.6" height="13.4" rx="1.4" fill="#413f4e"/>
      <rect x="20.2" y="0.6" width="11.2" height="13.4" rx="1.4" fill="#3a3947"/>
      <rect x="0.6" y="15.2" width="12" height="16.2" rx="1.4" fill="#3c3b49"/>
      <rect x="13.6" y="15.2" width="17.8" height="16.2" rx="1.4" fill="#444352"/>
    </g>
    <path d="M6 3 l4 6 l-2 4" stroke="#2a2933" stroke-width="1.1" fill="none" opacity="0.8"/>
    <path d="M20 20 l5 4" stroke="#2a2933" stroke-width="1" fill="none" opacity="0.7"/>
    <ellipse cx="24" cy="7" rx="5" ry="3" fill="#4b4a5b" opacity="0.4"/>
    <ellipse cx="8" cy="25" rx="5" ry="3" fill="#4b4a5b" opacity="0.32"/>
    <circle cx="17" cy="28" r="1.1" fill="#232230" opacity="0.9"/>
    <circle cx="28" cy="18" r="0.9" fill="#232230" opacity="0.8"/>`),

  dungeon_floor2: t(`
    <rect width="32" height="32" fill="#2f2e39"/>
    <g stroke="none">
      <rect x="0.6" y="0.6" width="11" height="13.4" rx="1.4" fill="#3b3a48"/>
      <rect x="12.6" y="0.6" width="18.8" height="13.4" rx="1.4" fill="#43424f"/>
      <rect x="0.6" y="15.2" width="18.4" height="16.2" rx="1.4" fill="#403f4d"/>
      <rect x="20" y="15.2" width="11.4" height="16.2" rx="1.4" fill="#393846"/>
    </g>
    <path d="M22 3 l-4 6 l2 4" stroke="#2a2933" stroke-width="1.1" fill="none" opacity="0.75"/>
    <path d="M6 21 l5 5" stroke="#2a2933" stroke-width="1" fill="none" opacity="0.65"/>
    <ellipse cx="8" cy="7" rx="5" ry="3" fill="#4b4a5b" opacity="0.36"/>
    <ellipse cx="25" cy="24" rx="4.6" ry="2.8" fill="#4b4a5b" opacity="0.3"/>
    <circle cx="14" cy="27" r="1" fill="#232230" opacity="0.85"/>`),

  // 벽 — 큰 돌을 엇갈려 쌓고, 아래로 갈수록 이끼가 앉는다.
  dungeon_wall: t(`
    <rect width="32" height="32" fill="#1d1c25"/>
    <g stroke="none">
      <rect x="0.6" y="0.6" width="14.4" height="9.6" rx="1.6" fill="#312f3d"/>
      <rect x="16" y="0.6" width="15.4" height="9.6" rx="1.6" fill="#2b2a36"/>
      <rect x="0.6" y="11.2" width="9.4" height="9.6" rx="1.6" fill="#2d2c39"/>
      <rect x="11" y="11.2" width="13" height="9.6" rx="1.6" fill="#343241"/>
      <rect x="25" y="11.2" width="6.4" height="9.6" rx="1.6" fill="#2a2935"/>
      <rect x="0.6" y="21.8" width="17" height="9.6" rx="1.6" fill="#2e2d3a"/>
      <rect x="18.6" y="21.8" width="12.8" height="9.6" rx="1.6" fill="#333140"/>
    </g>
    <g fill="#3d3b4b" opacity="0.55">
      <rect x="2" y="2" width="6" height="2.4" rx="1.2"/>
      <rect x="12.4" y="12.6" width="6" height="2.2" rx="1.1"/>
      <rect x="20" y="23.2" width="7" height="2.2" rx="1.1"/>
    </g>
    <path d="M3 26q3-4 6 0M20 29q2.5-3.5 5 0" stroke="#3d5a3a" stroke-width="1.4" fill="none" opacity="0.5"/>
    <path d="M13 22.4 q2 3 0 6" stroke="#151420" stroke-width="1" fill="none" opacity="0.7"/>`),

  // 벽 횃불 (0.68).
  //
  // 지하감옥은 횃불이 닿는 데까지만 보인다. 그 밖은 통째로 안 그리므로
  // **길을 찾을 실마리가 하나도 없었다** — 벽을 더듬는 것 말고는 방법이 없다.
  // 벽에 불을 걸어 두고, 그 불만은 어둠 밖에서도 보이게 한다(FieldScene).
  // 멀리 보이는 불빛 하나가 "저쪽에 길이 있다" 를 말해 준다.
  dungeon_torch: t(`
    <rect width="32" height="32" fill="#1d1c25"/>
    <g stroke="none">
      <rect x="0.6" y="0.6" width="14.4" height="9.6" rx="1.6" fill="#312f3d"/>
    ...
    <ellipse cx="16" cy="14" rx="13" ry="14" fill="#ffb457" opacity="0.2"/>
    <ellipse cx="16" cy="14" rx="7.5" ry="8.5" fill="#ffb457" opacity="0.22"/>
    <rect x="13" y="17" width="6" height="12" rx="2" fill="#3a3a46"/>
    <rect x="14" y="18" width="1.6" height="10" fill="#55545f"/>
    <path d="M11 19 q5 4 10 0" stroke="#3a3a46" stroke-width="2.4" fill="none"/>
    <ellipse cx="16" cy="13" rx="4.4" ry="6.4" fill="#ff7a2a" opacity="0.95"/>
    <ellipse cx="16" cy="13.8" rx="2.8" ry="4.4" fill="#ff9d3a"/>
    <ellipse cx="16" cy="14.4" rx="1.4" ry="2.6" fill="#ffe089"/>`),
