...
const PLAN = [
  { floor: 1, seed: 91001, rooms: 7, power: 14.711, monsters: ['elite_skeleton', 'elite_demon_soldier'], count: 12, name: '지하감옥 1층 · 무너진 감방' },
  { floor: 2, seed: 91002, rooms: 7, power: 12.273, monsters: ['elite_demon_soldier', 'dungeon_wraith'], count: 13, name: '지하감옥 2층 · 물 고인 복도' },
  { floor: 3, seed: 91003, rooms: 8, power: 12.883, monsters: ['dungeon_wraith', 'dungeon_golem'], count: 14, name: '지하감옥 3층 · 석상의 방' },
  { floor: 4, seed: 91004, rooms: 8, power: 11.055, monsters: ['dungeon_golem', 'dungeon_general'], count: 14, name: '지하감옥 4층 · 봉인된 층' },
  // 5층은 석상만 둔다. 망령(62)을 함께 두면 4층(석상 70)보다 낮은 숫자가 나와
  // 마지막 층에서 사다리가 한 칸 꺼진다. 보스방은 한 종류만 있어도 어색하지 않다.
  { floor: 5, seed: 91005, rooms: 6, power: 14.711, monsters: ['dungeon_golem'], count: 10, boss: 'dungeon_lord', name: '지하감옥 5층 · 주인의 자리' },
];
